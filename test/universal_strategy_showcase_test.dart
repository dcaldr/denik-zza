  ...
  group('🦄 Universal Strategy Showcase', () {
    ...
    group('2. Integration Mode (File Isolation)', () {
      ...
      test('should create files in isolated directory', () async {
        ...
        AppLogger.l.d(
            'Test running. FileManager homeDir: ${FileManager().homeDir?.path}');
        ...
        AppLogger.l.d('getHomeDir returned: ${homeDir?.path}');
    ...
    group('3. Debug Mode (Persistence)', () {
      ...
      setUp(() async {
        ...
        if (dbPath != null) {
          ...
          if (await file.exists()) {
            await file.delete();
            AppLogger.l.d('Deleted existing debug DB for test isolation');
          }
        }
      ...
      test('should persist data for inspection', () async {
        ...
        AppLogger.l.d('📝 Debug Output Location: ${homeDir.path}');
      });
    });
