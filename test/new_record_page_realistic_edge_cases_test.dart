...
void main() {
  group('NewRecordPage - Real Implementation Edge Cases', () {
    ...
    group('🎯 Basic Functionality Tests', () {
      testWidgets('SCENARIO: Page loads without participant - shows selection message', 
  ...
  expect(find.byKey(const Key('participant_autocomplete')), findsOneWidget);
      ...
      testWidgets('SCENARIO: Form opacity changes based on participant selection', 
        (WidgetTester tester) async {
        await _pumpNewRecordPage(tester);
    ...
    group('🚨 Form Validation Tests', () {
      ...
      testWidgets('SCENARIO: Save with participant but empty title shows validation error', 
        (WidgetTester tester) async {
        if (testParticipants.isNotEmpty) {
          final participant = testParticipants.first;
      ...
      testWidgets('SCENARIO: Form fields are disabled when no participant selected', 
        (WidgetTester tester) async {
        await _pumpNewRecordPage(tester);
      ...
      testWidgets('SCENARIO: Form fields are enabled when participant is selected', 
        (WidgetTester tester) async {
        if (testParticipants.isNotEmpty) {
          final participant = testParticipants.first;
    ...
    group('⌨️ Form Input Tests', () {
      testWidgets('SCENARIO: Can enter text in form fields when participant selected', 
        (WidgetTester tester) async {
        if (testParticipants.isNotEmpty) {
          final participant = testParticipants.first;
          ...
          // Verify text was entered
          expect(_getDescriptionText(tester), equals('Test injury description'));
        }
      });

      testWidgets('SCENARIO: Text entry is blocked when no participant selected', 
        (WidgetTester tester) async {
        await _pumpNewRecordPage(tester);
    ...
    group('🕒 DateTime Functionality Tests', () {
      testWidgets('SCENARIO: DateTime section is present and shows default text', 
        (WidgetTester tester) async {
        await _pumpNewRecordPage(tester);
  ...
  expect(find.byKey(const Key('datetime_change_button')), findsOneWidget);
    ...
    group('🔍 Real User Scenarios', () {
      testWidgets('SCENARIO: Complete workflow - select participant, fill form, save', 
        (WidgetTester tester) async {
        if (testParticipants.isNotEmpty) {
          final participant = testParticipants.first;
          ...
          await _enterDescription(tester, 'Small cut while using kitchen knife, cleaned and bandaged');
      ...
      testWidgets('SCENARIO: User tries to use form without selecting participant', 
        (WidgetTester tester) async {
        await _pumpNewRecordPage(tester);
