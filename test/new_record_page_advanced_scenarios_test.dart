...
void main() {
  group('NewRecordPage Warning & Edge Case Tests', () {
    ...
    group('Warning Behavior Tests', () {
      testWidgets('SCENARIO: Write text first → Warning should appear until participant selected', 
      ...
      testWidgets('SCENARIO: Save attempt without participant shows proper warning', 
        (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(home: const NewRecordPage()),
        );
  ...
  expect(find.byKey(const Key('NewRecordPage_participantAutocomplete')), findsOneWidget);
    ...
    group('Edge Case Combinations', () {
      testWidgets('COMBINATION: No participant + form interaction + save attempt', 
        (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(home: const NewRecordPage()),
        );
  ...
  final saveButton = find.byKey(const Key('save_button'));
      ...
      testWidgets('COMBINATION: Participant selected + form filled + validation', 
        (WidgetTester tester) async {
        final participant = testParticipants.first;
